...
// where we save the cache file
const CACHE_FILE = path.join(process.cwd(), '.cache', 'youtube.json')

// how long to keep data (playlist = 1 day, search = 6 hours)
...
// load cache from file when app starts
...
function saveCache() {
  try {
    ...
    // turn Map into a regular object so JSON can save it
    const obj = {}
...
// show how many things are cached
